...
Original file is located at
    https://colab.research.google.com/drive/1coFJ8MPBeWIoRhEuAuKruI8AkAkJh6ca
...
def row_func(t,n):
  # Put your code here.
  L=[f(n*t) for n in range(1,n+1) for f in [np.cos,np.sin]]
  L.insert(0,1)
...
def design_matrix(n):
  # Put your code here.
  L=[row_func(T[t],n) for t in range(len(T))]
  X=np.array(L)
...
MSE2=(np.linalg.norm(np.dot(X2,beta2)-Y)**2)/629  # Replace the 0 value with the mean square error you compute in Problem 8.
